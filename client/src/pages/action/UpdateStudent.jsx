              ...
              <div className="row mb-3">
                ...
                <div className="col-md-12">
                  <div className="d-flex flex-wrap align-items-start">
                    ...
                    <input type="text" className="form-control me-3 fc-common" id="dob-day" placeholder="DD" maxLength="2" name="dob-day"
                      value={values['dob-day']} onChange={handleDobChange} />
                    <input type="text" className="form-control me-3 fc-common" id="dob-month" placeholder="MM" maxLength="2" name="dob-month"
                      value={values['dob-month']} onChange={handleDobChange} />
                    <input type="text" className="form-control fc-common" id="dob-year" placeholder="YY" maxLength="4" name="dob-year"
                      value={values['dob-year']} onChange={handleDobChange} />
                      </span>
                  </div>
                </div>
